...
// طور المباراة الحي (إقصائيات): 'ET' أشواط إضافية · 'PENS' ركلات ترجيح · null إلغاء
export const adminSetPhase    = (matchId, phase) => rpc("admin_set_phase", { p_token: tok(), p_match_id: matchId, p_phase: phase });
